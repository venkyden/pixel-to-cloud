...
export const AIChatbot = () => {
    ...
    if (!isOpen) {
        return (
            <Button
                ...
                className="fixed bottom-6 right-6 h-14 w-14 rounded-full bg-gradient-to-r from-primary to-accent shadow-elegant hover:scale-110 hover:shadow-glow transition-all duration-300 z-50"
                size="icon"
            >
    ...
    return (
        <Card
            className={`fixed bottom-6 right-6 glass-effect border-border/50 shadow-elegant transition-all duration-300 z-50 ${isMinimized ? "w-80 h-16" : "w-96 h-[600px]"
